...
class ActorRolloutRefWorker(Worker):
    ...
    def _build_model_optimizer(self,
        ...
        if mixed_precision_config is not None:
            ...
            param_dtype = PrecisionType.to_dtype(self.config.ref.fsdp_config.get("dtype", "bfloat16"))
            print(f"Ref param_dtype: {param_dtype}")
    ...
    def compute_log_prob(self, data: DataProto) -> DataProto:
        ...
        with self.ulysses_sharding_manager:
            ...
            old_log_probs, entropy = self.actor.compute_log_prob(data=data, calculate_entropy=True)
            output = DataProto.from_dict(tensors={'old_log_probs': old_log_probs, 'entropy': entropy})
