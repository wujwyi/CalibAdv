...
def union_tensor_dict(tensor_dict1: TensorDict, tensor_dict2: TensorDict, enforce: bool) -> TensorDict:
...
class DataProto:
    ...
    def union(self, other: 'DataProto', enforce=False) -> 'DataProto':
        ...
        """
        self.batch = union_tensor_dict(self.batch, other.batch, enforce=enforce)
